...
<head>
    ...
    })(window, document, "clarity", "script", "gt6ucqzgoc");
</script>
</head>
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-TPRMP87X5S"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-TPRMP87X5S');
</script>
<body>
        ...
        <div class="card-main">
            <div class="card-section is-active" id="about">
                <div class="card-content">
                    ...
                    <p class="card-desc">Something wrong happened, your message has not been sent. Please try again later, or contact me on social media.
                    </p>
                </div>
